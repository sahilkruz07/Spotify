                    ...
                    <div class="chatbox-left">
                        ...
                        <div class="chats-box">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * from users where email IN (SELECT friend_email2 from friends where friend_email1 = '$semail')";
                                ...
                                for($i=0;$i < $rnum;$i++){
                                    echo '
                                    <a href="set_curr_email.php?curremail='.$chat_data[$i][1].'">
                    ...
                    <div class="chatbox-right">
                        ...
                        <div class="chat-area">
                            ...
                            <?php
                                ...
                                $curr_email = $_SESSION['curr-email'];
                                $curr_username = $_SESSION['curr-username'];


                                $sql = "SELECT * from chats where (sender_email = '$semail' and receiver_email = '$curr_email') or (sender_email = '$curr_email' and receiver_email = '$semail')";
                                $result = $conn->query($sql);
                                $rnum = mysqli_num_rows($result);
                                ...
                                for($i = 0;$i < $rnum;$i++)
                                {
                                    if($data_msg[$i][1] != $semail)
                                    {
                                        echo '
                                        <div class="msg msg-left">
                                        <div class="msg-header flex">
                                            <div class="sender-name">'.$curr_username.'</div>
                                            <div class="msg-date">'.$data_msg[$i][4].'</div>
                                        </div>
                                        <div class="msg-text">'.$data_msg[$i][3].'</div>
                                        </div>
